...
// offset)
//    *
//    * <p>NOTE: The field element start and end are always left to right from the perspective of
// the
//    * alliance station
//    */
...
//         new Translation2d(oppTopCenterPoint.getX() - width / 2.0, fieldWidth / 2.0 + width /
// 2.0);
