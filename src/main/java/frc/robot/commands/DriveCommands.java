...
public class DriveCommands {
  ...
  private static final double DRIVE_AND_SHOOT_ANGLE_P = 5.0; // experimental value
  ...
  public static Command joystickDriveAtAngle(
    ...
    ProfiledPIDController angleController =
        new ProfiledPIDController(
            ANGLE_KP, 0.0, ANGLE_KD, new TrapezoidProfile.Constraints(ANGLE_MAX_VELOCITY, 12.5)); //Broken atm
   ...
   */
  public static Command feedforwardCharacterization(SwerveSubsystem swerveSubsystem) {
    ...
    return Commands.sequence(
        ...
        Commands.run(
                () -> {
                  swerveSubsystem.runCharacterization(0.0);
                },
                swerveSubsystem)
        ...
        Commands.run(
                () -> {
                  ...
                  swerveSubsystem.runCharacterization(voltage);
                  velocitySamples.add(swerveSubsystem.getFFCharacterizationVelocity());
  ...
  public static Command wheelRadiusCharacterization(SwerveSubsystem swerveSubsystem) {
    ...
    return Commands.parallel(
        ...
        Commands.sequence(
            ...
            Commands.run(
                () -> {
                  ...
                  swerveSubsystem.runVelocity(new ChassisSpeeds(0.0, 0.0, speed));
                },
                swerveSubsystem)),
        ...
        Commands.sequence(
            ...
            Commands.runOnce(
                () -> {
                  state.positions = swerveSubsystem.getWheelRadiusCharacterizationPositions();
                  state.lastAngle = swerveSubsystem.getRotation();
                  state.gyroDelta = 0.0;
                }),
            ...
            Commands.run(
                    () -> {
                      var rotation = swerveSubsystem.getRotation();
                ...
                .finallyDo(
                    () -> {
                      double[] positions =
                          swerveSubsystem.getWheelRadiusCharacterizationPositions();
