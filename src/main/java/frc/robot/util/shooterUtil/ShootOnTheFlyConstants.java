...
public class ShootOnTheFlyConstants {
    ...
    public static final InterpolatingDoubleTreeMap FLYWHEEL_RPM_INTERPOLATOR = new InterpolatingDoubleTreeMap();
    public static final InterpolatingDoubleTreeMap HOOD_DEGREES_INTERPOLATOR = new InterpolatingDoubleTreeMap();
    public static final InterpolatingDoubleTreeMap FLYWHEEL_VELOCITY_INTERPOLATOR = new InterpolatingDoubleTreeMap();
