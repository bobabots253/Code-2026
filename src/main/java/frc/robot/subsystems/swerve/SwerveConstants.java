...
public class SwerveConstants {
  ...
  // Using Translation2D instead of SwerveDriveKinematics
  ...
  public static final int driveMotorCurrentLimit = 80; // Vortex 80A, NEO 60A
  ...
  public static final double driveMotorReduction =
      (45.0 * driveSpurTeeth) / (drivePinionTeeth * 15.0);
  ...
  public static final double driveKs = 0.12472; // Default 0.0
  public static final double driveKv = 0.08277; // Default 0.1
  ...
  public static final int turnMotorCurrentLimit = 35; // 550 35A, SAFE = 20A
  public static final double turnMotorReduction = 9424.0 / 203.0;
  public static final DCMotor turnGearbox = DCMotor.getNeo550(1);

  // Turn encoder configuration
  public static final boolean turnEncoderInverted = true; // <-- Check if Neccessary
